...
def test_retries_flag_and_provider_map_to_expected_policy(
    ...
    from dr_providers.transport.policy import ApiKeyEnv, ProviderBaseUrl
...
def test_entry_main_missing_cli_extra_exits_nonzero(
    ...
    # Re-importing the CLI app fails at its top-level ``import typer`` --
    # exactly the runtime condition the shim guards against.
    monkeypatch.delitem(
